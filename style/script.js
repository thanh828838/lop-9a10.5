document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        ...
        { name: 'Ngọc Hân', nickname: 'Thắng Riêu', quote:'bây ơi', img: 'syle/img/ThanhVien/Ngochan.jpg', hobbies: 'đồ ngọt, tiền', message: 'sau này ph sống tốt, có gì đừng im lặng, mọi chuyện còn t lo. Không hứa, chỉ dặn vậy thôi.', message2: 'Đừng buồn, ph luôn hạnh phúc, xa nhau r k còn ai kén ăn cho acu gank nữa đâu. Tui thương acu lắm'},
    ];
