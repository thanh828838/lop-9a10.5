document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        { name: 'Phước Thành', nickname: 'Mập', quote:'code đến già', img: 'style/img/ThanhVien/NguyenPhuocThanh.jpg', hobbies: 'Chụp ảnh, code', message: 'hẹn gặp lại sau này!' },
        { name: 'Khánh Nam', nickname: 'Vua Bright', quote:'Vua đến rồi', img: 'style/img/ThanhVien/LeKhanhNam.jpg', hobbies: 'Đá Banh, Em', message: 'Vua bright cũng không sáng bằng những ngày tháng cuối cấp này'},
        { name: 'Tường Quan', nickname: 'Thằng Tày', quote:'Bamboo', img: 'style/img/ThanhVien/DoTuongQuan.jpg', hobbies: 'Cristiano Ronaldo, Hotwheels', message: 'Tôi sẽ nhớ anh em lắm!'},
        { name: 'Ngọc Hân', nickname: 'Thắng Riêu', quote:'bây ơi', img: 'style/img/ThanhVien/NguyenHoangNgocHan.jpg', hobbies: 'đồ ngọt, tiền', message: 'sau này ph sống tốt, có gì đừng im lặng, mọi chuyện còn t lo. Không hứa, chỉ dặn vậy thôi. Đừng buồn, ph luôn hạnh phúc, xa nhau r k còn ai kén ăn cho acu gank nữa đâu. Tui thương acu lắm'},
        { name: 'Mỹ Dung', nickname: 'Thắng Ba Siêu', qoute: 'ê!!', img: 'style/img/ThanhVien/LeNguyenMyDung.jpg', hobbies: 'chồng, tiền', message: 'học và ăn đàng hoàng, xa t kco ai la hét làm ồn cho nghe đâu, sống tốt'},
        { name: 'Phước Vinh', nickname: 'Mk', qoute: 'là vua', img: 'style/img/ThanhVien/KhongPhuocvinh.jpg', hobbies: 'Thể thao, Âm nhạc', message: 'cảm ơn vì đã là một phần thanh xuân cấp 2! chúc anh em thi tốt!'},
        { name: 'Thanh Trúc', nickname: 'Trùm ff', qoute: 'ff không?', img: 'style/img/ThanhVien/Thanhtruc.jpg', hobbies: 'Ngủ, Ngủ', message: 'chúc anh em thi thật tốt, đậu nnv1'}, 
        { name: 'Lê Ngọc Anh', nickname: '', quote:'', img: 'style/img/ThanhVien/LeNgocAnh.jpg', hobbies: '', message: '' },
         { name: 'Phạm Tuấn Anh', nickname: '', quote:'', img: 'style/img/ThanhVien/PhamTuanAnh.jpg', hobbies: '', message: '' },
         { name: 'Trần Ngọc Bảo Anh', nickname: '', quote:'', img: 'style/img/ThanhVien/TranNgocBaoAnh.jpg', hobbies: '', message: '' },
        { name: 'Trần Quốc Kỳ Anh', nickname: '', quote:'', img: 'style/img/ThanhVien/TranQuocKyAnh.jpg', hobbies: '', message: '' },
        { name: 'Phạm Gia Bảo', nickname: '', quote:'', img: 'style/img/ThanhVien/PhamGiaBao.jpg', hobbies: '', message: '' },
       { name: 'Triệu Gia Bảo', nickname: '', quote:'', img: 'style/img/ThanhVien/TrieuGiaBao.jpg', hobbies: '', message: '' },
       { name: 'Lê Bội Châu', nickname: '', quote:'', img: 'style/img/ThanhVien/LeBoiChau.jpg', hobbies: '', message: '' },
       { name: 'Trần Ngọc Minh Châu', nickname: '', quote:'', img: 'style/img/ThanhVien/TranNgocMinhChau.jpg', hobbies: '', message: '' },
       { name: 'Lê Nguyễn Mỹ Dung', nickname: '', quote:'', img: 'style/img/ThanhVien/LeNguyenMyDung.jpg', hobbies: '', message: '' },
       { name: 'Hứa Nguyễn Thùy Dương', nickname: '', quote:'', img: 'style/img/ThanhVien/HuaNguyenThuyDuong.jpg', hobbies: '', message: '' },
       { name: 'Phạm Minh Đạt', nickname: '', quote:'', img: 'style/img/ThanhVien/PhamMinhDat.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Công Đức', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenCongDuc.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Minh Hiên', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenMinhHien.jpg', hobbies: '', message: '' },
       { name: 'Lưu Hương Ngọc Hiền', nickname: '', quote:'', img: 'style/img/ThanhVien/LuuHuongNgocHien.jpg', hobbies: '', message: '' },
       { name: 'Trần Lưu Đức Hưng', nickname: '', quote:'', img: 'style/img/ThanhVien/TranLuuDucHung.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Trọng Khang', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenTrongKhang.jpg', hobbies: '', message: '' },
       { name: 'Lê Anh Khôi', nickname: '', quote:'', img: 'style/img/ThanhVien/LeAnhKhoi.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Anh Khôi', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenAnhKhoi.jpg', hobbies: '', message: '' },
       { name: 'Trần Trung Kiệt', nickname: '', quote:'', img: 'style/img/ThanhVien/TranTrungKiet.jpg', hobbies: '', message: '' },
       { name: 'Vũ Trần Thiên Kim', nickname: '', quote:'', img: 'style/img/ThanhVien/VuTranThienKim.jpg', hobbies: '', message: '' },
       { name: 'Phạm Thanh Lâm', nickname: '', quote:'', img: 'style/img/ThanhVien/PhamThanhLam.jpg', hobbies: '', message: '' },
       { name: 'Phạm Doãn Khánh Ly', nickname: '', quote:'', img: 'style/img/ThanhVien/PhamDoanKhanhLy.jpg', hobbies: '', message: '' },
       { name: 'Châu Nguyễn Hải My', nickname: '', quote:'', img: 'style/img/ThanhVien/ChauNguyenHaiMy.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Tạ Mai Ngân', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenTaMaiNgan.jpg', hobbies: '', message: '' },
       { name: 'Danh Tường Nghi', nickname: '', quote:'', img: 'style/img/ThanhVien/DanhTuongNghi.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Thái Thy Ngọc', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenThaiThyNgoc.jpg', hobbies: '', message: '' },
       { name: 'Võ Thành Nhân', nickname: '', quote:'', img: 'style/img/ThanhVien/VoThanhNhan.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Lâm Bảo Như', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenLamBaoNhu.jpg', hobbies: '', message: '' },
       { name: 'Trần Thị Ngọc Như', nickname: '', quote:'', img: 'style/img/ThanhVien/TranThiNgocNhu.jpg', hobbies: '', message: '' },
       { name: 'Trần Nguyễn Minh Phương', nickname: '', quote:'', img: 'style/img/ThanhVien/TranNguyenMinhPhuong.jpg', hobbies: '', message: '' },
       { name: 'Cheam Hoàng Anh Quý', nickname: '', quote:'', img: 'style/img/ThanhVien/CheamHoangAnhQuy.jpg', hobbies: '', message: '' },
       { name: 'Ngụy Anh San', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyAnhSan.jpg', hobbies: '', message: '' },
       { name: 'Trần Hoàng Thuận', nickname: '', quote:'', img: 'style/img/ThanhVien/TranHoangThuan.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Ngọc Phương Thùy', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenNgocPhuongThuy.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Huỳnh Anh Thư', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenHuynhAnhThu.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Ngọc Nhã Trúc', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenNgocNhaTruc.jpg', hobbies: '', message: '' },
        { name: 'Trần Thị Thanh Trúc', nickname: '', quote:'', img: 'style/img/ThanhVien/TranThiThanhTruc.jpg', hobbies: '', message: '' },
        { name: 'Trương Tịnh Văn', nickname: '', quote:'', img: 'style/img/ThanhVien/TruongTinhVan.jpg', hobbies: '', message: '' },
       { name: 'Nguyễn Dương Hoàng Vũ', nickname: '', quote:'', img: 'style/img/ThanhVien/NguyenDuongHoangVu.jpg', hobbies: '', message: '' }
];
