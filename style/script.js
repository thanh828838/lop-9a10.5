document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        { name: 'Phước Thành', nickname: 'Mập'', quote: 'Code hết thanh xuân', img: 'style/img/ThanhVien/ThanhBinh.jpg', hobbies: 'code, chụp ảnh'', message: 'Hẹn gặp ở đỉnh vinh quang' },
        { name: 'Phước Vinh'', nickname: 'Mk'', quote: 'Sống hết tuổi trẻ bằng đam mê', img: 'style/img/ThanhVien/ThuNgan.jpg', hobbies: 'bóng rổ, Mk', message: 'rực rỡ trên con đườnh đã chon' },
