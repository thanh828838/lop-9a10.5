document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        ...
        { name: 'Phước Vinh', nickname: 'Mk', qoute: 'là vua', img: 'style/img/ThanhVien/KhKhongPhuocVinh.jpg', hobbies: 'Thể thao, Âm nhạc', message: 'cảm ơn vì đã là một phần thanh xuân cấp 2! chúc anh em thi tốt!'},
