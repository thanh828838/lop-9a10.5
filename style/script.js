document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        ...
        { name: 'Ngọc Hân', nickname: 'Thắng Riêu', quote:'bây ơi', img: 'style/img/ThanhVien/Ngochan.jpg', hobbies: 'đồ ngọt, tiền', message: 'sau này ph sống tốt, có gì đừng im lặng, mọi chuyện còn t lo. Không hứa, chỉ dặn vậy thôi. Đừng buồn, ph luôn hạnh phúc, xa nhau r k còn ai kén ăn cho acu gank nữa đâu. Tui thương acu lắm'},
        { name: 'Mỹ Dung', nickname: 'Thắng Ba Siêu', qoute: 'ê!!', img: 'style/img/ThanhVien/Mydung.jpg', hobbies: 'chồng, tiền', message: 'học và ăn đàng hoàng, xa t kco ai la hét làm ồn cho nghe đâu, sống tốt'},
        { name: 'Phước Vinh', nickname: 'Mk', qoute: 'là vua', img: 'style/img/ThanhVien/Phuocvinh.jpg', hobbies: 'Thể thao, Âm nhạc', message: 'cảm ơn vì đã là một phần thanh xuân cấp 2! chúc anh em thi tốt!'},
    ];
